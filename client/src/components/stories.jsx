		...
		<div className="flex gap-[10px] h-[250px] mb-[30px]">
			<div className="flex-[1] rounded-md overflow-hidden relative">
				<img
					...
					alt=""
				/>
				<span className=" absolute bottom-[10px] left-[10px] text-white text-sm">
					{currentUser.name}
				</span>
				<Button
					size="icon"
					className="absolute bottom-[40px] left-[10px] rounded-full bg-gradient-to-tl from-violet-600 to-indigo-600 border-none flex items-center justify-center"
				>
